...
const OnboardingStepsPage = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      apiData.append("sex", formData.sex.charAt(0).toUpperCase() + formData.sex.slice(1)); // Normalize to "Male"/"Female"
      ...
      apiData.append("muscular", formData.goals.includes("Muscular") ? "1" : "0");
      ...
      toast.error(error?.data?.message || "Failed to save profile. Please try again.");
    }
  };
