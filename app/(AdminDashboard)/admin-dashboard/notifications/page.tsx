...
const getNotificationIcon = (type: string | null) => {
  ...
  return <Bell size={24} className="text-[#0FA4A9]" />; // Default icon to Admin Teal
};
...
const getNotificationIconBg = (type: string | null) => {
  ...
  return "bg-[#0FA4A9]/10"; // Default bg
};
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div className="space-y-2">
          ...
          <p className="text-[#5F6F73] font-medium leading-relaxed">
            Manage system activity, user updates, and administrative alerts.
          </p>
        </div>
        ...
        {notifications.length === 0 && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#5F6F73] font-medium">System updates and user alerts will appear here.</p>
            </div>
          </motion.div>
        )}
      </div>
