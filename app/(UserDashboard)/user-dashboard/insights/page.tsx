...
const CURRENT_PROJECTIONS = [
  {
    ...
    impact:
      "better energy levels, improved body composition, and enhanced recovery.",
    steps: [
    ...
    trainerNote:
      '"I Noticed Your Caloric Intake Spikes On Weekends While Protein Drops. Try Prepping 3 High-Protein Snack Packs On Friday Nights To Keep Your Metabolic Rate Stable."',
  ...
  },
  {
    ...
    impact:
      "faster physical recovery, significantly better mental clarity, and improved mood stability.",
    steps: [
    ...
    trainerNote:
      "\"Your HRV (Heart Rate Variability) Is Consistently Lower On Tuesday Mornings. This Correlates With Your Monday Night Late-Night Emails. Try A 'digital Sunset' At 9 PM On Mondays Specifically.\"",
  ...
  },
  {
    ...
    impact:
      "lower resting heart rate and increased endurance for daily activities.",
    steps: [
    ...
    trainerNote:
      '"Don\'t Overthink This. Even A 20-Minute Brisk Walk To The Coffee Shop Counts. Keep It Effortless So You Actually Do It."',
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col mt-2">
                    ...
                    <p className="text-[#5F6F73] italic text-sm">{proj.why}</p>
                  </div>
                </div>
