    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
      ...
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <h1 className="text-3xl font-bold text-[#041228]">Your Future Projection</h1>
          ...
          <p className="text-[#5F6F73] leading-relaxed max-w-xl">
            BioVue uses your lifestyle data and uploaded photos to create visual and data-based future projections under different scenarios. These insights help you visualize long-term trends in vitality, body composition, and aging markers.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-[#3A86FF]/25 shadow-sm space-y-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-[#041228]">Choose a time horizon</span>
          </div>

          <div className="flex p-1 bg-[#F8FAFF] border border-gray-200 rounded-xl w-full">
            {(["6 months", "1 Years", "5 Years"] as TimeHorizon[]).map((time) => (
              <button
                key={time}
          ...
          <div className="space-y-3">
            ...
            <div 
              ...
              className={cn(
                ...
                lifestyle === "current" ? "border-[#3A86FF] bg-[#F8FAFF]" : "border-gray-50 hover:border-gray-100"
              )}
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-[#5F6F73] mt-1">Projected outcomes based on current habits.</p>
              </div>
              <div className={cn(
                "w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 mt-1",
                lifestyle === "current" ? "border-[#3A86FF] bg-[#3A86FF]" : "border-gray-300"
              )}>
                {lifestyle === "current" && <CheckCircle2 size={12} className="text-white" />}
              </div>
            </div>
            ...
            <div 
              ...
              className={cn(
                "flex items-start gap-4 p-4 rounded-xl border-2 transition-all cursor-pointer",
                lifestyle === "improved" ? "border-[#3A86FF] bg-[#F8FAFF]" : "border-gray-50 hover:border-gray-100"
              )}
            >
              <div className="w-10 h-10 bg-[#E4EFFF] rounded-lg flex items-center justify-center shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-[#5F6F73] mt-1">change goal alignment to &quot;your current goals&quot;</p>
              </div>
              <div className={cn(
                "w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 mt-1",
                lifestyle === "improved" ? "border-[#3A86FF] bg-[#3A86FF]" : "border-gray-300"
              )}>
                {lifestyle === "improved" && <CheckCircle2 size={12} className="text-white" />}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-[24px] overflow-hidden border border-[#3A86FF]/20 flex flex-col items-center p-12 text-center shadow-sm">
          ...
          <h3 className="font-bold text-[#041228] uppercase tracking-wider mb-4">VERIFIED BASELINE PHOTO</h3>
          ...
          <p className="text-[10px] text-gray-400 mt-6 leading-relaxed bg-[#F8FAFF] py-2 px-4 rounded-lg border border-gray-100">
            Note: For more accurate projections, please upload a photo in a swim suit.
          </p>
        </div>
    ...
    <div className="fixed inset-0 z-[100] bg-white/40 backdrop-blur-md flex items-center justify-center p-6 overflow-hidden">
      <div className="bg-white rounded-[32px] p-12 max-w-md w-full shadow-2xl border border-gray-100 flex flex-col items-center text-center space-y-8 animate-in zoom-in-95 duration-300">
        ...
        <div className="relative w-48 h-48 flex items-center justify-center">
          ...
          <span className="absolute text-4xl font-extrabold text-[#3A86FF]">{progress}%</span>
        </div>

        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-[#041228]">Your Future Projection</h2>
  ...
  const renderResultsStep = () => (
    <div className="space-y-12 pb-12 animate-in fade-in duration-700">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-[#3A86FF]">Projection Results</h1>
        <p className="text-gray-500">Visualizing your trajectory over the next 5 Years.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-[24px] border border-[#3A86FF]/10 shadow-sm overflow-hidden flex flex-col">
          <div className="p-8 text-center space-y-6 flex-1">
            ...
            <div className="space-y-4 pt-4">
              {[
                { label: "Timeframe", value: "5 Years", icon: Calendar, color: "text-[#8B5CF6]", bg: "bg-[#F3E8FF]" },
                { label: "East. BMI:", value: "40.2", icon: Activity, color: "text-[#10B981]", bg: "bg-[#E1F9F0]" },
                { label: "Est. Weight:", value: "264.3 lbs", icon: Zap, color: "text-[#3A86FF]", bg: "bg-[#E4EFFF]" },
              ].map((item, idx) => (
                <div key={idx} className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-[#041228]">{item.value}</span>
                </div>
              ))}
            </div>
        ...
        <div className="bg-white rounded-[24px] border border-[#3A86FF]/10 shadow-sm overflow-hidden flex flex-col">
          <div className="p-8 text-center space-y-6 flex-1">
            <h3 className="text-[#8B5CF6] font-bold text-lg min-h-[56px] flex items-center justify-center">
              Achieving your goal: Lose 40 lbs and reach muscular physique in 5 years
            </h3>
            <div className="relative w-full aspect-[4/3.2] rounded-2xl overflow-hidden bg-gray-50 shadow-inner">
              <Image 
            ...
            <div className="space-y-4 pt-4">
              {[
                { label: "Timeframe", value: "5 Years", icon: Calendar, color: "text-[#8B5CF6]", bg: "bg-[#F3E8FF]" },
                { label: "East. BMI:", value: "25", icon: Activity, color: "text-[#10B981]", bg: "bg-[#E1F9F0]" },
                { label: "Est. Weight:", value: "164.4 lbs", icon: Zap, color: "text-[#3A86FF]", bg: "bg-[#E4EFFF]" },
              ].map((item, idx) => (
                <div key={idx} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={cn("w-8 h-8 rounded-lg flex items-center justify-center shrink-0", item.bg)}>
      ...
      <div className="bg-[#E4F4F5] rounded-xl p-6 border border-[#0FA4A9]/20 flex items-start gap-4">
        ...
        <p className="text-xs text-[#1F2D2E] leading-relaxed">
          <span className="font-bold">Illustrative projection:</span> Visuals show relative change based on statistical modeling, not exact or guaranteed outcomes. This interface is for motivational purposes and does not constitute medical advice.
        </p>
      </div>
      ...
      {step === "input" && (
        <div className="mt-12 bg-[#E4F4F5] rounded-xl p-6 border border-[#0FA4A9]/20 flex items-start gap-4">
          ...
          <p className="text-[10px] text-[#1F2D2E] leading-relaxed">
            <span className="font-bold uppercase tracking-wider">Disclaimer:</span> Information and projections provided by BioVue Digital Wellness are for informational and illustrative purposes only, reflect relative changes rather than exact outcomes, and do not constitute medical advice. BioVue Digital Wellness is not liable for decisions or outcomes based on this information; users should consult a qualified medical professional for medical guidance.
          </p>
        </div>
      )}
    </div>
