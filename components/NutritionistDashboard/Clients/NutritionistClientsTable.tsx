...
export default function NutritionistClientsTable({ clients, limit }: ClientsTableProps) {
              ...
              return (
                <TableRow key={client.user_id}>
                  ...
                  {/* <TableCell className="py-3 text-base md:text-lg">
                    <Link href={`/nutritionist-dashboard/clients/${client.user_id}`}>
                      <button className="flex gap-5 items-center cursor-pointer hover:opacity-80  border px-4 py-1 rounded-full border-[#0FA4A9] text-[#0FA4A9] font-medium transition-all">
                        View
                      </button>
                    </Link>
                  </TableCell> */}
